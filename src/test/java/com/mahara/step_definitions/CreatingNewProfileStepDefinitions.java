...
public class CreatingNewProfileStepDefinitions {
	...
	public void in_the_new_page_user_enter_into_introduction_part(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void user_enter_mobile_phone_number(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^user enter \"([^\"]*)\" into official website address box$")
	public void user_enter_into_official_website_address_box(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^user enter \"([^\"]*)\" into postal address box$")
	public void user_enter_into_postal_address_box(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^user enter \"([^\"]*)\" into city/region box$")
	public void user_enter_into_city_region_box(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void enter_into_the_occupation_part(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^user should see changes on new profile$")
	public void user_should_see_changes_on_new_profile() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
